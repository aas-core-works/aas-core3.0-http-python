...
def modelling_kind_from_str(text: str) -> Optional[aas_types.ModellingKind]:
    ...
    of :py:class:`aas_core3_http.ModellingKind`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.ModellingKind`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.ModellingKind`
...
def qualifier_kind_from_str(text: str) -> Optional[aas_types.QualifierKind]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.QualifierKind`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.QualifierKind`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.QualifierKind`
        or ``None``, if :paramref:`text` invalid.
    """
...
def asset_kind_from_str(text: str) -> Optional[aas_types.AssetKind]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.AssetKind`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.AssetKind`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.AssetKind`
        or ``None``, if :paramref:`text` invalid.
    """
...
def aas_submodel_elements_from_str(
    ...
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.AASSubmodelElements`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.AASSubmodelElements`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.AASSubmodelElements`
        or ``None``, if :paramref:`text` invalid.
    """
...
def entity_type_from_str(text: str) -> Optional[aas_types.EntityType]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.EntityType`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.EntityType`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.EntityType`
        or ``None``, if :paramref:`text` invalid.
    """
...
def direction_from_str(text: str) -> Optional[aas_types.Direction]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.Direction`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.Direction`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.Direction`
        or ``None``, if :paramref:`text` invalid.
    """
...
def state_of_event_from_str(text: str) -> Optional[aas_types.StateOfEvent]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.StateOfEvent`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.StateOfEvent`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.StateOfEvent`
        or ``None``, if :paramref:`text` invalid.
    """
...
def reference_types_from_str(text: str) -> Optional[aas_types.ReferenceTypes]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.ReferenceTypes`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.ReferenceTypes`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.ReferenceTypes`
        or ``None``, if :paramref:`text` invalid.
    """
...
def key_types_from_str(text: str) -> Optional[aas_types.KeyTypes]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.KeyTypes`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.KeyTypes`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.KeyTypes`
        or ``None``, if :paramref:`text` invalid.
    """
...
def data_type_def_xsd_from_str(text: str) -> Optional[aas_types.DataTypeDefXSD]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.DataTypeDefXSD`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.DataTypeDefXSD`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.DataTypeDefXSD`
        or ``None``, if :paramref:`text` invalid.
    """
...
def data_type_iec_61360_from_str(text: str) -> Optional[aas_types.DataTypeIEC61360]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.DataTypeIEC61360`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.DataTypeIEC61360`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.DataTypeIEC61360`
        or ``None``, if :paramref:`text` invalid.
    """
    return _DATA_TYPE_IEC_61360_FROM_STR.get(text, None)


_MESSAGETYPE_FROM_STR: Mapping[str, aas_types.Messagetype] = {
    "Undefined": aas_types.Messagetype.UNDEFINED,
    "Info": aas_types.Messagetype.INFO,
    "Warning": aas_types.Messagetype.WARNING,
    "Error": aas_types.Messagetype.ERROR,
    "Exception": aas_types.Messagetype.EXCEPTION,
}


def messagetype_from_str(text: str) -> Optional[aas_types.Messagetype]:
    """
    Parse :paramref:`text` as string representation
    of :py:class:`aas_core3_http.Messagetype`.

    If :paramref:`text` is not a valid string representation of a literal
    of :py:class:`aas_core3_http.Messagetype`, return ``None``.

    :param text: to be parsed
    :return:
        the corresponding literal of :py:class:`aas_core3_http.Messagetype`
        or ``None``, if :paramref:`text` invalid.
    """
    return _MESSAGETYPE_FROM_STR.get(text, None)
