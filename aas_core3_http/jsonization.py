...
import aas_core3_http.common as aas_common
...
class _SetterForPagedResultPagingMetadata:
    """Provide de-serialization-setters for properties."""
    ...
    def set_cursor_from_jsonable(
            self,
            jsonable: Jsonable
    ) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~cursor`.

        :param jsonable: input to be parsed
        """
        self.cursor = _str_from_jsonable(
            jsonable
        )


def paged_result_paging_metadata_from_jsonable(
        jsonable: Jsonable
) -> aas_types.PagedResultPagingMetadata:
    """
    Parse an instance of :py:class:`.types.PagedResultPagingMetadata` from the JSON-able
    structure :paramref:`jsonable`.

    :param jsonable: structure to be parsed
    :return: Parsed instance of :py:class:`.types.PagedResultPagingMetadata`
    :raise: :py:class:`DeserializationException` if unexpected :paramref:`jsonable`
    """
    if not isinstance(jsonable, collections.abc.Mapping):
        raise DeserializationException(
    ...
    setter = _SetterForPagedResultPagingMetadata()

    for key, jsonable_value in jsonable.items():
        setter_method = (
            _SETTER_MAP_FOR_PAGED_RESULT_PAGING_METADATA.get(key)
        )
        if setter_method is None:
            raise DeserializationException(
                f"Unexpected property: {key}"
    ...
    if setter.cursor is None:
        raise DeserializationException(
            "The required property 'cursor' is missing"
        )

    return aas_types.PagedResultPagingMetadata(
        setter.cursor
    )


def paged_result_from_jsonable(
        jsonable: Jsonable
) -> aas_types.PagedResult:
    """
    Parse an instance of :py:class:`.types.PagedResult` from the JSON-able
    structure :paramref:`jsonable`.

    :param jsonable: structure to be parsed
    :return: Concrete instance of :py:class:`.types.PagedResult`
    :raise: :py:class:`DeserializationException` if unexpected :paramref:`jsonable`
    """
    if not isinstance(jsonable, collections.abc.Mapping):
        raise DeserializationException(
    ...
    dispatch = _PAGED_RESULT_FROM_JSONABLE_DISPATCH.get(model_type, None)
    if dispatch is None:
        raise DeserializationException(
            f"Unexpected model type for PagedResult: {model_type}"
        )

    return dispatch(jsonable)


class _SetterForPagedResult:
    """Provide de-serialization-setters for properties."""
    ...
    def set_paging_metadata_from_jsonable(
            self,
            jsonable: Jsonable
    ) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~paging_metadata`.

        :param jsonable: input to be parsed
        """
        self.paging_metadata = paged_result_paging_metadata_from_jsonable(
            jsonable
        )


def _paged_result_from_jsonable_without_dispatch(
        jsonable: Jsonable
) -> aas_types.PagedResult:
    """
    Parse an instance of :py:class:`.types.PagedResult` from the JSON-able
    ...
    is called from within a dispatching function, and you never call it
    directly. If you want to de-serialize an instance of
    :py:class:`.types.PagedResult`, call
    :py:func:`paged_result_from_jsonable`.

    :param jsonable: structure to be parsed
    :return: Parsed instance of :py:class:`.types.PagedResult`
    :raise: :py:class:`DeserializationException` if unexpected :paramref:`jsonable`
    """
    if not isinstance(jsonable, collections.abc.Mapping):
        raise DeserializationException(
    ...
    setter = _SetterForPagedResult()

    for key, jsonable_value in jsonable.items():
        setter_method = (
            _SETTER_MAP_FOR_PAGED_RESULT.get(key)
        )
        if setter_method is None:
            raise DeserializationException(
                f"Unexpected property: {key}"
    ...
    if setter.paging_metadata is None:
        raise DeserializationException(
            "The required property 'pagingMetadata' is missing"
        )

    return aas_types.PagedResult(
        setter.paging_metadata
    )
...
class _SetterForGetAssetAdministrationShellResult:
    ...
    def set_result_from_jsonable(
            self,
            jsonable: Jsonable
    ) -> None:
        """
        Parse :paramref:`jsonable` as the value of :py:attr:`~result`.
...
def get_asset_administration_shell_result_from_jsonable(
    ...
    for key, jsonable_value in jsonable.items():
        setter_method = (
            _SETTER_MAP_FOR_GET_ASSET_ADMINISTRATION_SHELL_RESULT.get(key)
        )
        if setter_method is None:
            raise DeserializationException(
                f"Unexpected property: {key}"
    ...
    if setter.result is None:
        raise DeserializationException(
            "The required property 'result' is missing"
        )
...
def get_submodel_result_from_jsonable(
        jsonable: Jsonable
) -> aas_types.GetSubmodelResult:
    """
    Parse an instance of :py:class:`.types.GetSubmodelResult` from the JSON-able
    structure :paramref:`jsonable`.

    :param jsonable: structure to be parsed
    :return: Parsed instance of :py:class:`.types.GetSubmodelResult`
    :raise: :py:class:`DeserializationException` if unexpected :paramref:`jsonable`
    """
    if not isinstance(jsonable, collections.abc.Mapping):
        raise DeserializationException(
    ...
    setter = _SetterForGetSubmodelResult()

    for key, jsonable_value in jsonable.items():
        setter_method = (
            _SETTER_MAP_FOR_GET_SUBMODEL_RESULT.get(key)
        )
        if setter_method is None:
            raise DeserializationException(
                f"Unexpected property: {key}"
...
_SETTER_MAP_FOR_PAGED_RESULT_PAGING_METADATA: Mapping[
    str,
    Callable[
        [_SetterForPagedResultPagingMetadata, Jsonable],
        None
    ]
] = {
    'cursor':
        _SetterForPagedResultPagingMetadata.set_cursor_from_jsonable,
    'modelType':
        _SetterForPagedResultPagingMetadata.ignore
}


_PAGED_RESULT_FROM_JSONABLE_DISPATCH: Mapping[
    str,
    Callable[[Jsonable], aas_types.PagedResult]
] = {
...
_SETTER_MAP_FOR_PAGED_RESULT: Mapping[
    str,
    Callable[
        [_SetterForPagedResult, Jsonable],
        None
    ]
] = {
    'pagingMetadata':
        _SetterForPagedResult.set_paging_metadata_from_jsonable,
    'modelType':
        _SetterForPagedResult.ignore
}
...
_SETTER_MAP_FOR_GET_ASSET_ADMINISTRATION_SHELL_RESULT: Mapping[
    str,
    Callable[
        [_SetterForGetAssetAdministrationShellResult, Jsonable],
        None
    ]
] = {
    'pagingMetadata':
        _SetterForGetAssetAdministrationShellResult.set_paging_metadata_from_jsonable,
    'result':
        _SetterForGetAssetAdministrationShellResult.set_result_from_jsonable,
    'modelType':
        _SetterForGetAssetAdministrationShellResult.ignore
}


_SETTER_MAP_FOR_GET_SUBMODEL_RESULT: Mapping[
    str,
    Callable[
        [_SetterForGetSubmodelResult, Jsonable],
        None
    ]
] = {
    'pagingMetadata':
        _SetterForGetSubmodelResult.set_paging_metadata_from_jsonable,
    'result':
        _SetterForGetSubmodelResult.set_result_from_jsonable,
    'modelType':
        _SetterForGetSubmodelResult.ignore
}
...
class _Serializer(
    ...
    # noinspection PyMethodMayBeStatic
    def transform_paged_result_paging_metadata(
        self,
        that: aas_types.PagedResultPagingMetadata
    ) -> MutableJsonable:
        """Serialize :paramref:`that` to a JSON-able representation."""
        jsonable: MutableMapping[str, MutableJsonable] = dict()

        jsonable['cursor'] = that.cursor

        return jsonable

    def transform_paged_result(
        self,
        that: aas_types.PagedResult
    ) -> MutableJsonable:
        """Serialize :paramref:`that` to a JSON-able representation."""
        jsonable: MutableMapping[str, MutableJsonable] = dict()
    ...
    def transform_get_asset_administration_shell_result(
        self,
        that: aas_types.GetAssetAdministrationShellResult
    ) -> MutableJsonable:
        """Serialize :paramref:`that` to a JSON-able representation."""
        jsonable: MutableMapping[str, MutableJsonable] = dict()
    ...
    def transform_get_submodel_result(
        self,
        that: aas_types.GetSubmodelResult
    ) -> MutableJsonable:
        """Serialize :paramref:`that` to a JSON-able representation."""
        jsonable: MutableMapping[str, MutableJsonable] = dict()
