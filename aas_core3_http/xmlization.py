...
For writing, use the function :py:func:`aas_core3_http.xmlization.write` which
...
.. code-block::
    ...
    import aas_core3_http.types as aas_types
    import aas_core3_http.xmlization as aas_xmlization
...
import aas_core3_http.stringification as aas_stringification
import aas_core3_http.types as aas_types
...
def paged_result_paging_metadata_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.PagedResultPagingMetadata:
    """
    Read an instance of :py:class:`.types.PagedResultPagingMetadata` from
    the :paramref:`iterator`.
    ...
    .. code-block::
        ...
        with path.open("rt") as fid:
            ...
            instance = aas_xmlization.paged_result_paging_metadata_from_iterparse(
                iterator
            )
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.PagedResultPagingMetadata` read from
        :paramref:`iterator`
    """
    next_event_element = next(iterator, None)
    if next_event_element is None:
        raise DeserializationException(
            # fmt: off
            "Expected the start element for PagedResultPagingMetadata, "
            "but got the end-of-input"
            # fmt: on
        )
    ...
    if next_event != "start":
        raise DeserializationException(
            f"Expected the start element for PagedResultPagingMetadata, "
            f"but got event {next_event!r} and element {next_element.tag!r}"
        )

    try:
        return _read_paged_result_paging_metadata_as_element(next_element, iterator)
    except DeserializationException as exception:
        exception.path._prepend(ElementSegment(next_element))
        raise exception


def paged_result_paging_metadata_from_stream(
    stream: TextIO, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.PagedResultPagingMetadata:
    """
    Read an instance of :py:class:`.types.PagedResultPagingMetadata` from
    ...
    .. code-block::
        ...
        with open_some_stream_over_network(...) as stream:
            instance = aas_xmlization.paged_result_paging_metadata_from_stream(
                stream
            )
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.PagedResultPagingMetadata` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
    ...
    """
    iterator = has_iterparse.iterparse(stream, ["start", "end"])
    return paged_result_paging_metadata_from_iterparse(
        _with_elements_cleared_after_yield(iterator)
    )


def paged_result_paging_metadata_from_file(
    path: PathLike, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.PagedResultPagingMetadata:
    """
    Read an instance of :py:class:`.types.PagedResultPagingMetadata` from
    ...
    .. code-block::
        ...
        path = pathlib.Path(...)
        instance = aas_xmlization.paged_result_paging_metadata_from_file(
            path
        )
...
def paged_result_paging_metadata_from_str(
    text: str, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.PagedResultPagingMetadata:
    """
    Read an instance of :py:class:`.types.PagedResultPagingMetadata` from
    ...
    .. code-block::
        ...
        text = "<...>...</...>"
        instance = aas_xmlization.paged_result_paging_metadata_from_str(
            text
        )
...
def paged_result_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.PagedResult:
    """
    Read an instance of :py:class:`.types.PagedResult` from
    the :paramref:`iterator`.
    ...
    .. code-block::
        ...
        with path.open("rt") as fid:
            ...
            instance = aas_xmlization.paged_result_from_iterparse(
                iterator
            )
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.PagedResult` read from
        :paramref:`iterator`
    """
    next_event_element = next(iterator, None)
    if next_event_element is None:
        raise DeserializationException(
            # fmt: off
            "Expected the start element for PagedResult, "
            "but got the end-of-input"
            # fmt: on
        )
    ...
    if next_event != "start":
        raise DeserializationException(
            f"Expected the start element for PagedResult, "
            f"but got event {next_event!r} and element {next_element.tag!r}"
        )

    try:
        return _read_paged_result_as_element(next_element, iterator)
    except DeserializationException as exception:
        exception.path._prepend(ElementSegment(next_element))
        raise exception


def paged_result_from_stream(
    stream: TextIO, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.PagedResult:
    """
    Read an instance of :py:class:`.types.PagedResult` from
    ...
    .. code-block::
        ...
        with open_some_stream_over_network(...) as stream:
            instance = aas_xmlization.paged_result_from_stream(
                stream
            )
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.PagedResult` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
...
def paged_result_from_file(
    ...
    .. code-block::
        ...
        path = pathlib.Path(...)
        instance = aas_xmlization.paged_result_from_file(
            path
        )
...
def paged_result_from_str(
    ...
    .. code-block::
        ...
        text = "<...>...</...>"
        instance = aas_xmlization.paged_result_from_str(
            text
        )
...
def get_submodel_result_from_iterparse(
    iterator: Iterator[Tuple[str, Element]]
) -> aas_types.GetSubmodelResult:
    """
    Read an instance of :py:class:`.types.GetSubmodelResult` from
    the :paramref:`iterator`.
    ...
    .. code-block::
        ...
        with path.open("rt") as fid:
            ...
            instance = aas_xmlization.get_submodel_result_from_iterparse(
                iterator
            )
    ...
    :raise: :py:class:`DeserializationException` if unexpected input
    :return:
        Instance of :py:class:`.types.GetSubmodelResult` read from
        :paramref:`iterator`
    """
    next_event_element = next(iterator, None)
    if next_event_element is None:
        raise DeserializationException(
            # fmt: off
            "Expected the start element for GetSubmodelResult, "
            "but got the end-of-input"
            # fmt: on
        )
    ...
    if next_event != "start":
        raise DeserializationException(
            f"Expected the start element for GetSubmodelResult, "
            f"but got event {next_event!r} and element {next_element.tag!r}"
        )

    try:
        return _read_get_submodel_result_as_element(next_element, iterator)
    except DeserializationException as exception:
        exception.path._prepend(ElementSegment(next_element))
        raise exception


def get_submodel_result_from_stream(
    stream: TextIO, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.GetSubmodelResult:
    """
    Read an instance of :py:class:`.types.GetSubmodelResult` from
    ...
    .. code-block::
        ...
        with open_some_stream_over_network(...) as stream:
            instance = aas_xmlization.get_submodel_result_from_stream(
                stream
            )
    ...
    :param stream:
        representing an instance of
        :py:class:`.types.GetSubmodelResult` in XML
    :param has_iterparse:
        Module containing ``iterparse`` function.
...
def get_submodel_result_from_file(
    path: PathLike, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.GetSubmodelResult:
    """
    Read an instance of :py:class:`.types.GetSubmodelResult` from
    ...
    .. code-block::
        ...
        path = pathlib.Path(...)
        instance = aas_xmlization.get_submodel_result_from_file(
            path
        )
...
def get_submodel_result_from_str(
    text: str, has_iterparse: HasIterparse = xml.etree.ElementTree
) -> aas_types.GetSubmodelResult:
    """
    Read an instance of :py:class:`.types.GetSubmodelResult` from
    ...
    .. code-block::
        ...
        text = "<...>...</...>"
        instance = aas_xmlization.get_submodel_result_from_str(
            text
        )
...
class _ReaderAndSetterForDataSpecificationIEC61360:
    ...
    def __init__(self) -> None:
        ...
        self.short_name: Optional[List[aas_types.LangStringShortNameTypeIEC61360]] = (
            None
        )
        ...
        self.definition: Optional[List[aas_types.LangStringDefinitionTypeIEC61360]] = (
            None
        )
...
class _ReaderAndSetterForPagedResultPagingMetadata:
    """
    Provide a buffer for reading and setting the properties for the class
    :py:class:`PagedResultPagingMetadata`.

    The properties correspond to the constructor arguments of
    :py:class:`PagedResultPagingMetadata`. We use this buffer to facilitate dispatching when
    parsing the properties in a streaming fashion.
    """
    ...
    def read_and_set_cursor(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.PagedResultPagingMetadata.cursor` and set it.
        """
        self.cursor = _read_str_from_element_text(element, iterator)


def _read_paged_result_paging_metadata_as_sequence(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.PagedResultPagingMetadata:
    """
    Read an instance of :py:class:`.types.PagedResultPagingMetadata`
    as a sequence of XML-encoded properties.
    ...
    reader_and_setter = _ReaderAndSetterForPagedResultPagingMetadata()
    ...
    while True:
        ...
        read_and_set_method = (
            _READ_AND_SET_DISPATCH_FOR_PAGED_RESULT_PAGING_METADATA.get(tag_wo_ns, None)
        )
        if read_and_set_method is None:
            an_exception = DeserializationException(
                f"Expected an element representing a property, "
    ...
    if reader_and_setter.cursor is None:
        raise DeserializationException("The required property 'cursor' is missing")

    return aas_types.PagedResultPagingMetadata(reader_and_setter.cursor)


def _read_paged_result_paging_metadata_as_element(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.PagedResultPagingMetadata:
    """
    Read an instance of :py:class:`.types.PagedResultPagingMetadata` from
    ...
    if tag_wo_ns != "pagedResultPagingMetadata":
        raise DeserializationException(
            f"Expected the element with the tag 'pagedResultPagingMetadata', "
            f"but got tag: {tag_wo_ns}"
        )

    return _read_paged_result_paging_metadata_as_sequence(element, iterator)


class _ReaderAndSetterForPagedResult:
    """
    Provide a buffer for reading and setting the properties for the class
    :py:class:`PagedResult`.

    The properties correspond to the constructor arguments of
    :py:class:`PagedResult`. We use this buffer to facilitate dispatching when
    parsing the properties in a streaming fashion.
    """

    def __init__(self) -> None:
        """Initialize with all the properties unset."""
        self.paging_metadata: Optional[aas_types.PagedResultPagingMetadata] = None

    def read_and_set_paging_metadata(
        self, element: Element, iterator: Iterator[Tuple[str, Element]]
    ) -> None:
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.PagedResult.paging_metadata` and set it.
        """
...
def _read_paged_result_as_sequence(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.PagedResult:
    """
    Read an instance of :py:class:`.types.PagedResult`
    as a sequence of XML-encoded properties.
    ...
    reader_and_setter = _ReaderAndSetterForPagedResult()
    ...
    while True:
        ...
        read_and_set_method = _READ_AND_SET_DISPATCH_FOR_PAGED_RESULT.get(
            tag_wo_ns, None
        )
        if read_and_set_method is None:
            an_exception = DeserializationException(
    ...
    if reader_and_setter.paging_metadata is None:
        raise DeserializationException(
            "The required property 'pagingMetadata' is missing"
        )

    return aas_types.PagedResult(reader_and_setter.paging_metadata)


def _read_paged_result_as_element(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.PagedResult:
    """
    Read an instance of :py:class:`.types.PagedResult` from
    ...
    """
    tag_wo_ns = _parse_element_tag(element)
    read_as_sequence = _DISPATCH_FOR_PAGED_RESULT.get(tag_wo_ns, None)

    if read_as_sequence is None:
        raise DeserializationException(
            f"Expected the element tag to be a valid model type "
            f"of a concrete instance of 'PagedResult', "
            f"but got tag {tag_wo_ns!r}"
        )
...
class _ReaderAndSetterForGetShellResult:
    ...
    def __init__(self) -> None:
        """Initialize with all the properties unset."""
        self.paging_metadata: Optional[aas_types.PagedResultPagingMetadata] = None
        self.result: Optional[List[aas_types.AssetAdministrationShell]] = None
...
class _ReaderAndSetterForGetSubmodelResult:
    """
    Provide a buffer for reading and setting the properties for the class
    :py:class:`GetSubmodelResult`.

    The properties correspond to the constructor arguments of
    :py:class:`GetSubmodelResult`. We use this buffer to facilitate dispatching when
    parsing the properties in a streaming fashion.
    """
    ...
    def __init__(self) -> None:
        """Initialize with all the properties unset."""
        self.paging_metadata: Optional[aas_types.PagedResultPagingMetadata] = None
        self.result: Optional[List[aas_types.Submodel]] = None
    ...
    def read_and_set_paging_metadata(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.GetSubmodelResult.paging_metadata` and set it.
        """
        self.paging_metadata = _read_paged_result_paging_metadata_as_sequence(
            element, iterator
        )
    ...
    def read_and_set_result(
        ...
        """
        Read :paramref:`element` as the property
        :py:attr:`.types.GetSubmodelResult.result` and set it.
        """
        if element.text is not None and len(element.text.strip()) != 0:
            raise DeserializationException(
                f"Expected only item elements and whitespace text, "
...
def _read_get_submodel_result_as_sequence(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.GetSubmodelResult:
    """
    Read an instance of :py:class:`.types.GetSubmodelResult`
    as a sequence of XML-encoded properties.
    ...
    reader_and_setter = _ReaderAndSetterForGetSubmodelResult()
    ...
    while True:
        ...
        read_and_set_method = _READ_AND_SET_DISPATCH_FOR_GET_SUBMODEL_RESULT.get(
            tag_wo_ns, None
        )
        if read_and_set_method is None:
            an_exception = DeserializationException(
    ...
    return aas_types.GetSubmodelResult(
        reader_and_setter.paging_metadata, reader_and_setter.result
    )


def _read_get_submodel_result_as_element(
    element: Element, iterator: Iterator[Tuple[str, Element]]
) -> aas_types.GetSubmodelResult:
    """
    Read an instance of :py:class:`.types.GetSubmodelResult` from
    ...
    if tag_wo_ns != "getSubmodelResult":
        raise DeserializationException(
            f"Expected the element with the tag 'getSubmodelResult', "
            f"but got tag: {tag_wo_ns}"
        )
...
#: Dispatch XML property name to read & set method in
#: :py:class:`_ReaderAndSetterForPagedResultPagingMetadata`
_READ_AND_SET_DISPATCH_FOR_PAGED_RESULT_PAGING_METADATA: Mapping[
    str,
    Callable[
        [
            _ReaderAndSetterForPagedResultPagingMetadata,
            Element,
            Iterator[Tuple[str, Element]],
        ],
        None,
    ...
    "cursor": _ReaderAndSetterForPagedResultPagingMetadata.read_and_set_cursor,
}


#: Dispatch XML class names to read-as-sequence functions
#: corresponding to PagedResult and its concrete descendants
_DISPATCH_FOR_PAGED_RESULT: Mapping[
...
#: Dispatch XML property name to read & set method in
#: :py:class:`_ReaderAndSetterForPagedResult`
_READ_AND_SET_DISPATCH_FOR_PAGED_RESULT: Mapping[
    str,
    Callable[
        [_ReaderAndSetterForPagedResult, Element, Iterator[Tuple[str, Element]]], None
    ],
] = {
    "pagingMetadata": _ReaderAndSetterForPagedResult.read_and_set_paging_metadata,
}
...
#: Dispatch XML property name to read & set method in
#: :py:class:`_ReaderAndSetterForGetSubmodelResult`
_READ_AND_SET_DISPATCH_FOR_GET_SUBMODEL_RESULT: Mapping[
    str,
    Callable[
        [_ReaderAndSetterForGetSubmodelResult, Element, Iterator[Tuple[str, Element]]],
        None,
    ],
] = {
...
class _Serializer(aas_types.AbstractVisitor):
    ...
    def _write_paged_result_paging_metadata_as_sequence(
        self, that: aas_types.PagedResultPagingMetadata
    ) -> None:
        """
        Serialize :paramref:`that` to :py:attr:`~stream` as a sequence of
        XML elements.
        ...
        :param that: instance to be serialized
        """
        self._write_str_property("cursor", that.cursor)

    def visit_paged_result_paging_metadata(
        self, that: aas_types.PagedResultPagingMetadata
    ) -> None:
        """
        Serialize :paramref:`that` to :py:attr:`~stream` as an XML element.
        ...
        :param that: instance to be serialized
        """
        self._write_start_element("pagedResultPagingMetadata")
        self._write_paged_result_paging_metadata_as_sequence(that)
        self._write_end_element("pagedResultPagingMetadata")

    def _write_paged_result_as_sequence(self, that: aas_types.PagedResult) -> None:
        """
        Serialize :paramref:`that` to :py:attr:`~stream` as a sequence of
        XML elements.
        ...
        :param that: instance to be serialized
        """
        self._write_start_element("pagingMetadata")
        self._write_paged_result_paging_metadata_as_sequence(that.paging_metadata)
        self._write_end_element("pagingMetadata")

    def visit_paged_result(self, that: aas_types.PagedResult) -> None:
        """
        Serialize :paramref:`that` to :py:attr:`~stream` as an XML element.
        ...
        :param that: instance to be serialized
        """
        self._write_start_element("pagedResult")
    ...
    def _write_get_shell_result_as_sequence(
        ...
        if len(that.result) == 0:
            self._write_empty_element("result")
        else:
            self._write_start_element("result")
            for an_item in that.result:
                self.visit(an_item)
    ...
    def visit_get_submodel_result(self, that: aas_types.GetSubmodelResult) -> None:
        """
        Serialize :paramref:`that` to :py:attr:`~stream` as an XML element.
