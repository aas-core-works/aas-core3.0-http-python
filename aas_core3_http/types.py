...
class PagedResult(Class):
    ...
    def transform_with_context(
        ...
        Dispatch the :paramref:`transformer` on this instance in :paramref:`context`.
        """
        return transformer.transform_paged_result_with_context(
            self, context)
...
class GetSubmodelResult(PagedResult):
    ...
    def transform_with_context(
        ...
        Dispatch the :paramref:`transformer` on this instance in :paramref:`context`.
        """
        return transformer.transform_get_submodel_result_with_context(
            self, context)
...
class AbstractVisitor:
    ...
    def visit_paged_result_paging_metadata(
            self,
            that: PagedResultPagingMetadata
    ) -> None:
        """Visit :paramref:`that`."""
        raise NotImplementedError()

    @abc.abstractmethod
    def visit_paged_result(
            self,
            that: PagedResult
    ) -> None:
        """Visit :paramref:`that`."""
    ...
    def visit_get_asset_administration_shell_result(
            self,
            that: GetAssetAdministrationShellResult
    ) -> None:
        """Visit :paramref:`that`."""
        raise NotImplementedError()

    @abc.abstractmethod
    def visit_get_submodel_result(
            self,
            that: GetSubmodelResult
    ) -> None:
        """Visit :paramref:`that`."""
        raise NotImplementedError()
