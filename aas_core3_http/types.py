...
class PagedResultPagingMetadata(Class):
    ...
    def accept(self, visitor: "AbstractVisitor") -> None:
        """Dispatch the :paramref:`visitor` on this instance."""
        visitor.visit_paged_result_paging_metadata(self)

    def accept_with_context(
        self, visitor: "AbstractVisitorWithContext[ContextT]", context: ContextT
    ) -> None:
        """Dispatch the :paramref:`visitor` on this instance in :paramref:`context`."""
        visitor.visit_paged_result_paging_metadata_with_context(self, context)

    def transform(self, transformer: "AbstractTransformer[T]") -> T:
        """Dispatch the :paramref:`transformer` on this instance."""
        return transformer.transform_paged_result_paging_metadata(self)
    ...
    def transform_with_context(
        ...
        Dispatch the :paramref:`transformer` on this instance in :paramref:`context`.
        """
        return transformer.transform_paged_result_paging_metadata_with_context(
            self, context
        )
...
class PagedResult(Class):
    ...
    def descend(self) -> Iterator[Class]:
        ...
        yield from self.paging_metadata.descend()

    def accept(self, visitor: "AbstractVisitor") -> None:
        """Dispatch the :paramref:`visitor` on this instance."""
        visitor.visit_paged_result(self)

    def accept_with_context(
        self, visitor: "AbstractVisitorWithContext[ContextT]", context: ContextT
    ) -> None:
        """Dispatch the :paramref:`visitor` on this instance in :paramref:`context`."""
        visitor.visit_paged_result_with_context(self, context)

    def transform(self, transformer: "AbstractTransformer[T]") -> T:
        """Dispatch the :paramref:`transformer` on this instance."""
        return transformer.transform_paged_result(self)
    ...
    def transform_with_context(
        ...
        Dispatch the :paramref:`transformer` on this instance in :paramref:`context`.
        """
        return transformer.transform_paged_result_with_context(self, context)

    def __init__(self, paging_metadata: "PagedResultPagingMetadata") -> None:
        """Initialize with the given values."""
...
class GetSubmodelResult(PagedResult):
    ...
    def accept(self, visitor: "AbstractVisitor") -> None:
        """Dispatch the :paramref:`visitor` on this instance."""
        visitor.visit_get_submodel_result(self)

    def accept_with_context(
        self, visitor: "AbstractVisitorWithContext[ContextT]", context: ContextT
    ) -> None:
        """Dispatch the :paramref:`visitor` on this instance in :paramref:`context`."""
        visitor.visit_get_submodel_result_with_context(self, context)

    def transform(self, transformer: "AbstractTransformer[T]") -> T:
        """Dispatch the :paramref:`transformer` on this instance."""
        return transformer.transform_get_submodel_result(self)
    ...
    def transform_with_context(
        ...
        Dispatch the :paramref:`transformer` on this instance in :paramref:`context`.
        """
        return transformer.transform_get_submodel_result_with_context(self, context)

    def __init__(
        self, paging_metadata: "PagedResultPagingMetadata", result: List["Submodel"]
    ) -> None:
        """Initialize with the given values."""
        PagedResult.__init__(self, paging_metadata)
        self.result = result
...
class AbstractVisitor:
    ...
    def visit_paged_result_paging_metadata(
        self, that: PagedResultPagingMetadata
    ) -> None:
        """Visit :paramref:`that`."""
        raise NotImplementedError()

    @abc.abstractmethod
    def visit_paged_result(self, that: PagedResult) -> None:
        """Visit :paramref:`that`."""
        raise NotImplementedError()
...
class AbstractVisitorWithContext(Generic[ContextT]):
    ...
    @abc.abstractmethod
    def visit_paged_result_paging_metadata_with_context(
        self, that: PagedResultPagingMetadata, context: ContextT
    ) -> None:
        """Visit :paramref:`that` in :paramref:`context`."""
        raise NotImplementedError()

    @abc.abstractmethod
    def visit_paged_result_with_context(
        self, that: PagedResult, context: ContextT
    ) -> None:
        """Visit :paramref:`that` in :paramref:`context`."""
        raise NotImplementedError()
...
class AbstractTransformer(Generic[T]):
    ...
    @abc.abstractmethod
    def transform_paged_result(self, that: PagedResult) -> T:
        """Transform :paramref:`that`."""
        raise NotImplementedError()
...
class AbstractTransformerWithContext(Generic[ContextT, T]):
    ...
    @abc.abstractmethod
    def transform_paged_result_paging_metadata_with_context(
        self, that: PagedResultPagingMetadata, context: ContextT
    ) -> T:
        """Transform :paramref:`that` in :paramref:`context`."""
        raise NotImplementedError()
    ...
    @abc.abstractmethod
    def transform_paged_result_with_context(
        self, that: PagedResult, context: ContextT
    ) -> T:
        """Transform :paramref:`that` in :paramref:`context`."""
        raise NotImplementedError()
